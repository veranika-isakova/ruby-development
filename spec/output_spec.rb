...
RSpec.describe TemplateGenerator_dsl do
  ...
  it 'should have the second output with changed parameters' do
    ...
    expect(TemplateGenerator_dsl.generate(options)).to eq(ExampleTwo::OUTPUT)
  end
end
